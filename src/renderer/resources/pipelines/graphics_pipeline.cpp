...
ter::GraphicsPipeline::GraphicsPipeline(VulkanApplication &va, Shader *shader)
{
  _shader = shader;
  ...
  vk::PipelineInputAssemblyStateCreateInfo input_assembly_create_info { .topology = _topology, .primitiveRestartEnable = false };
  ...
  vk::GraphicsPipelineCreateInfo pipeline_create_info
  {
    ...
    .stageCount = _shader->get_stages_number(),
