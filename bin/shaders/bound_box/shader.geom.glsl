...
void main()
{
  ...
  vec3 v[8];
  v[0] = vec3(bb_data.minBB.x, bb_data.minBB.y, bb_data.minBB.z);
  v[1] = vec3(bb_data.maxBB.x, bb_data.minBB.y, bb_data.minBB.z);
  v[2] = vec3(bb_data.maxBB.x, bb_data.maxBB.y, bb_data.minBB.z);
  v[3] = vec3(bb_data.minBB.x, bb_data.maxBB.y, bb_data.minBB.z);
  v[4] = vec3(bb_data.minBB.x, bb_data.minBB.y, bb_data.maxBB.z);
  v[5] = vec3(bb_data.maxBB.x, bb_data.minBB.y, bb_data.maxBB.z);
  v[6] = vec3(bb_data.maxBB.x, bb_data.maxBB.y, bb_data.maxBB.z);
  v[7] = vec3(bb_data.minBB.x, bb_data.maxBB.y, bb_data.maxBB.z);
